...
так як в завданні було вказано, що потрібно реалізувати це все на OOP та не використовувати сторонні фреймворки та бібліотеки, я реалізував міні фреймворк на чистому PHP.
